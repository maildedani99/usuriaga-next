...
export default function SharedProductViewCard({ product }) {
...
const router = useRouter()
    ...
    return (
        <div className="flex w-full   mx-auto text-[#636364] bg-white p-4    ">
            <div className="flex flex-col lg:flex-row flex-1 justify-evenly ">
                {product ?
                    <>
                        <div className="flex flex-col my-auto w-full justify-center lg:w-4/12 ">
                            <CarouselWrapper product={product} />
                        </div>
                        <div className="text-2xl flex flex-col my-auto w-full lg:w-2/6 ml-16">
