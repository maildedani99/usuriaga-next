  ...
  return (
    <NavbarWrapper open={open}>
      <div className="flex flex-1 w-full  flex-col text-[#636364]   bg-white h-screen	">
        <div className="text-xl  mt-16	 mx-2 capitalize cursor-pointer">
        ...
        categories?.map(
          (category) =>
            category.subcategories.length > 0 && (
              <div
                key={category.id}
                className="flex  w-full  text-xl  mt-5	  capitalize mx-6  cursor-pointer "
              >
        ...
        <div className="text-xl  mt-5	  mx-2 capitalize cursor-pointer">
          <Link
