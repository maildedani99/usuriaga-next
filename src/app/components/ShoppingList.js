...
export default function ShoppingList() {
  ...
  useEffect(() => {
    setOrder((prevOrder) => ({
      ...prevOrder,
      orderAmount: roundToTwoDecimals(discountedSubtotal + envio),
    }));
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [discountedSubtotal, envio]);
    ...
    <div className="flex flex-col flex-1 mx-10 h-auto">
      ...
      <div className="text-base mx-auto mt-16 mb-16 border-t border-primary">
        ...
        <div className="flex flex-1 mx-auto justify-between mt-1">
          ...
          <span className="font-medium ml-3">-{formatPrice(discount)} €</span>
        </div>
        ...
        <div className="flex flex-1 mx-auto justify-between mt-1">
          ...
          <span className="font-bold ml-3">
            {formatPrice(discountedSubtotal + envio)} €
          </span>
        </div>
      </div>
    </div>
