...
export default function Terms () {
    ...
    return (
      ...
      <h2 className="text-5xl mx-auto">Términos y Condiciones</h2>
      <h3 className="text-3xl mt-14">Privacidad</h3>
      <p className="text-justify mt-5">
        En cumplimiento de la LOPD 15/1999 y de la LSSI-CE 34/2002, se informa
        al interesado que los datos de carácter personal que voluntariamente
        facilita, incluido su correo electrónico, se incorporarán a un fichero
        automatizado propiedad y responsabilidad de Usuriaga Collection. Al
        remitir el interesado sus datos, expresamente autoriza la utilización de
      ...
      <p className="text-justify mt-5">
        ...
        carácter personal, le informamos de que los datos recabados en nuestros
        formularios serán incluidos en un fichero automatizado de datos cuya
        única finalidad es poder servir a sus peticiones. No se destinarán en
        ningún otro caso a ninguna otra finalidad, ni se entregarán en ningún
        caso a terceras partes, de acuerdo con los principios de protección de
        datos de carácter personal de la LORTAD (Ley orgánica 15/1999, de 13 de
        diciembre).
      </p>
      <h3 className="text-3xl mt-14">
      ...
      <p className="text-justify mt-5">
        ...
        propiedad de Usuriaga Collection, de la cual formará parte. Por medio
        del envío de nuestros formularios, vd. consiente expresamente la
